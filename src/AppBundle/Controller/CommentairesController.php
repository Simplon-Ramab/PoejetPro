...
class CommentairesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $commentaires = $em->getRepository('AppBundle:Commentaires')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\CommentairesType', $commentaire);
    ...
    {
        $deleteForm = $this->createDeleteForm($commentaire);
        $editForm = $this->createForm('AppBundle\Form\CommentairesType', $commentaire);
